    ...
    <GlassCard id="contact" className="p-8 md:p-12 space-y-12 relative overflow-hidden group">
      ...
      <div className="flex justify-center">
        <div className="w-full max-w-md">
          <div className="flex items-center gap-4 p-8 rounded-2xl border border-white/5 bg-white/[0.02] group/email hover:border-primary/20 transition-all duration-300">
            ...
            <div className="flex flex-col">
              ...
              <a href="mailto:rontaylor_23@hotmail.com" className="text-xl md:text-2xl font-bold text-foreground hover:text-primary transition-colors">
